...
class ALE_Prom_Categories extends WP_List_Table {
	...
	public function prepare_items() {
		...
		$this->set_pagination_args(
			array(
				'total_items' => wp_count_terms( $this->screen->taxonomy, $args ),
	...
	public function display_rows_or_placeholder() {
        ...
        $this->callback_args['hide_empty'] = true;
    ...
    public function column_term_id( $tag ) {
		$taxonomy = $this->screen->taxonomy;
    ...
    public function column_percent( $tag ) {
		$taxonomy = $this->screen->taxonomy;

		$category_id = $tag->term_id; 
		$percent = 0;

		$conf_cat = $this->get_conf_cat_by_id ($category_id);
		
		if($conf_cat && !empty($conf_cat->percent)) {
			$percent = $conf_cat->percent;
		}
		...
		$out .= '<div class="percent">' . $percent . '</div>';
	...
	public function set_conf_cats($conf_cats) {
		$this->conf_cats = $conf_cats;
	}

	public function get_conf_cats() {
		if(isset($this->conf_cats)) {
			return $this->conf_cats;
		}
	}

	public function get_conf_cat_by_id ($category_id) {
		$conf_cats = $this->get_conf_cats();
		foreach($conf_cats as $conf_cat) {
			if($conf_cat->category_id == $category_id) {
				return $conf_cat;
			}
		}
		return false;
	...
	public function inline_edit() {
		...
		<table style="display: none"><tbody id="inlineedit">
			...
			<div style='width:50%;margin:0 auto;'>
				<fieldset>
					<!--<legend style="" class="inline-edit-legend"><?php _e( 'Quick Edit' ); ?></legend>-->
					<div class="inline-edit-col">
					<label style="">
						<span class="title"><?php _ex( 'Name', 'term name' ); ?></span>
						
						<input style="width:30%" disabled type="text" name="name" class="ptitle" value="" />
						
					</label>

					<label style="">
						<span class="title"><?php _e( 'Percent', 'ale-prom-import' ); ?></span>
						<input type="text" name="percent" class="ptitle" value="" />
					</label>
			...
			<div class="inline-edit-save submit">
				...
				<button style="margin-left:10px"type="button" class="save button button-primary">
					<?php _e('Обновить наценку','ale-prom-import' ) ?>
				</button>
